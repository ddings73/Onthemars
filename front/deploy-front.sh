...
sudo docker rmi e207/front-$IDLE_PROFILE:$IDLE_TAG
sudo docker pull e207/front-$IDLE_PROFILE:$IDLE_TAG
docker run -d -p $IDLE_PORT:${$IDLE_PORT} --name front-$IDLE_PROFILE e207/front-$IDLE_PROFILE:$IDLE_TAG
